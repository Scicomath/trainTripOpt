...
{\begin{CJK}{GBK}{song}\fontsize{14pt}{\baselineskip}\selectfont \bfseries \begin{center}{\Large\the\year}~高教社杯全国大学生数学建模竞赛\par\vspace{.5\baselineskip}\par
{\fontsize{15.75pt}{\baselineskip}\selectfont 承\  诺\  书}
\end{center}\end{CJK}\par\vspace{1\ccht}\par}\input CCT.sty
...
如有违反竞赛规则的行为，我们将受到严肃处理。\par
\par\vspace{2\ccht}\par
\raisebox{1ex}[0pt]{我们参赛选择的题号是（从A/B/C/D中选择一项填写）：}\vbox{\hbox to5.4cm{\hfil \the\xuanti \hfil}
        \protect\vspace{0.6truemm}\relax
        \hrule depth0pt height0.15truemm width5.05cm}\par
\vspace{1mm}
...
\end{center}\end{CJK}\par\vspace{1\ccht}\par}
\input CCT.sty
{\zihao{-4}%
\par\vfill
